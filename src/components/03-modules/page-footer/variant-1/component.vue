...
<script>
  ...
  export default {
    name: 'PageFooter',
    components: {
      Listen, Container, Layout, PageHeader, ProductList, Logo, PrimaryNavigation, Accordion, ProgressIndicator, Pane, Form, LoginForm, Legend, Card, CopyBlock, H1, H2, H3,H4, H5, T1, T2, T3,
    ...
    computed: {
      classes() {
        return `page-footer ${this.classList}`;  
      }
    },
    methods: {
    }
